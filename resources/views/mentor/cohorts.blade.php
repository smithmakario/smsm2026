...
@section('title', 'Cohorts – MentorHub')
...
<div class="p-6">
    ...
    @forelse($cohorts as $cohort)
        <a href="{{ route('mentor.cohorts.show', $cohort) }}" class="block mb-4 bg-white dark:bg-[#1a2632] border border-slate-200 dark:border-[#344d65] rounded-xl p-5 hover:border-primary/50 transition-all shadow-sm">
